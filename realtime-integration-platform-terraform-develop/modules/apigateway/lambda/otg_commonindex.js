...
// Your code goes here.
        ...
        var otg_Salesuser=jsonobj.otg_Sales_UserID;
        var otg_Salespassword=jsonobj.otg_Sales_Password;
        
        if (!(username === otg_Salesuser && password === otg_Salespassword)) return callback('Unauthorized')
