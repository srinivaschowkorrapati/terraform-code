...
// Your code goes here.
        ...
        var salesforceuser=jsonobj.Salesforce_UserID;
        var salesforcepwd=jsonobj.Salesforce_Password;
        
        if (!(username === salesforceuser && password === salesforcepwd)) return callback('Unauthorized')
