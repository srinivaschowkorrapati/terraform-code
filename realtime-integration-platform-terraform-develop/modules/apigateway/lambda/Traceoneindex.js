...
// Your code goes here.
        ...
        var Traceoneuser=jsonobj.Traceone_UserID;
        var Traceonepassword=jsonobj.Traceone_Password;
        
        if (!(username === Traceoneuser && password === Traceonepassword)) return callback('Unauthorized')
