...
locals {
  config_name_1 = "app-intg-platform-${var.env}-retail-corp-broker-1"
}

# Configuration file Broker  1
resource "aws_mq_configuration" "retail_corp_mq_configuration_1" {
  description    = "Configuration for retail corp MQ : AMQBroker 1"
  name           = local.config_name_1
